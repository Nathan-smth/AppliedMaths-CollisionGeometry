...
int main()
{
    sf::RenderWindow window(sf::VideoMode(sf::VideoMode::getDesktopMode().width, sf::VideoMode::getDesktopMode().height), "Applied Maths!");
    ...
    sf::Vector2f player1BoundsOffset(4, 0);
    sf::Vector2f player1BoundsScale(0.75f, 1);

    sf::Vector2f player2BoundsOffset(4, 0);
    sf::Vector2f player2BoundsScale(0.75f, 1);
